...
<div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $sql ="SELECT  * from studentstable where student_id=$id";
                    ...
                    $totalpaid= $row['value_sum'];
                        ...
                        <div id="block_bg" class="block">   
                           ...
                           <td> <a button type='button' class="btn btn-primary" href="feestudents.php">Back</a></td>
                           <td><input type="submit" name="submit" class="btn btn-primary" value="Print Invoice"></td>                                        
                            </form>
                           </tr></table>


                            <strong>Student's Name:&nbsp;<?php echo $firstname; ?>,&nbsp;&nbsp;&nbsp;fee payable:&nbsp;&nbsp;&nbsp;<?php echo $feepayable; ?>,&nbsp;Amount paid:&nbsp;&nbsp;&nbsp;<?php echo $totalpaid; ?></strong>
