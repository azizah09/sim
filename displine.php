...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="departments.php">Record New Case <img src="assets/img/new.png"> </a></li>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          ...
                          <h4>Department Details</h4>                            
                            ...
                            <label>Date </label>
                            <input type="date" name="date_c" class="form-control" required>
...
<!--****************************************************************************-->
  ...
  <?php
    ...
    if (isset($_POST['register'])){
     ...
     mysql_query("INSERT INTO displinary_case(student_id,date_c, displine_case) VALUES ('$student_id','$date_c','$displine_case')") or die(mysql_error());
