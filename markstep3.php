...
$id = $_GET['id'];
    $select = "SELECT * FROM 
            studentstable WHERE student_id='$id'";
...
<script type="text/javascript">
            ...
            var social_studies = parseInt(document.getElementById("social_studies").value);
            var final =((maths + science + english + kiswahili + social_studies)/5);
            var result=Math.round(final);
            ...
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="markstep3.php" method="POST" enctype="multipart/form-data">
                     <div style="float:left; position:relative">  
                        ...
                        <td><input type="text" name="student_id"  value="<?php echo $id?>" class="form-control"></td> 
                    ...
                    <h4><font color="green">Subjects</font></h4>
                        ...
                        <input type="number" name="maths" class="form-control" min="0" value="0" id="maths" onkeyup="final()">

                        <label>English</label>
                            <table><tr>
                            <td>Composition
                            <input type="number" id="a" class="form-control"  onkeyup="sum()" max="40" >
                            </td>
                            <td>Grammer
                            <input type="number" id="b" class="form-control"  onkeyup="sum()" max="50" >
                            </td></tr></table>
                            <input type="number" name="english" class="form-control"   id="english" readonly onkeyup="final()">
                        <label>Kiswahili</label>
                        <table><tr>
                            <td>Insha
                            <input type="number" id="c" class="form-control"  onkeyup="sum2()" max="40" >
                            </td>
                            <td>Sanifu
                            <input type="number" id="d" class="form-control" onkeyup="sum2()" max="50">
                            </td></tr></table>
                            <input type="number" name="kiswahili" class="form-control"  id="kiswahili" readonly onkeyup="final()">

                        <label>Chemistry</label>
                        <input type="number" name="science" id="science" class="form-control" min="0" value="0" onkeyup="final()"> 

                        <label> Pysics/Biology</label>
                        <input type="number" name="social_studies" id="social_studies" class="form-control" min="0" value="0" onkeyup="final()"><br>
                        </div>
                        
                        <input type="text" name="average" id="average" readonly class="form-control" placeholder="Average"  ><br>
...
mysql_query("INSERT INTO marks(student_id,course_id,term,year,exam_series,maths,english,kiswahili,social_studies,science, average ) VALUES ('$student_id','$course_id','$term','$year','$exam_series','$maths','$english','$kiswahili','$social_studies','$science','$average')") or die(mysql_error());
?>
<?php 
