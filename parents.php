...
<?php
                      ...
                      $id=$_GET['id'];
                        $query="SELECT * FROM studentstable WHERE student_id=$id";
                        $records2=mysqli_query($db,$query);
                        while($row=mysqli_fetch_array($records2, MYSQL_ASSOC))
                        {
                        $id1 = $row['student_id'];
                        }?>
...
<!--end of heading section-->  
    ...
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="parents.php">Parents/Guardians  <img src="assets/img/details.png"></a></li>
...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="#">New <img src="assets/img/new.png"> </a></li>

                                  <li><a href="#">Manage Guardians <img src="assets/img/update2.png"> </a></li>
                                  <li><a href="#">Send SMS (Bulk)<img src="assets/img/marks2.png"></a></li>
  ...
  <!--*************************************************************************************************************************-->
                        ...
                        <form action="parents.php" method="POST" enctype="multipart/form-data">
                            <tr><td style="height:0.2px;"><h4>Guardian/Parent and other Details for student(ID)&nbsp;&nbsp;<?php echo $id1;?> 
                      </h4></td></tr>
                            <tr><td>
                            <center>Student ID</center><input type="text" name="student_id" class="form-control input-md" value="<?php echo $id1;?>" readonly></td></tr>
                            <tr><td>
                                
                                Sir name&nbsp;&nbsp;<input type="text" name="sirname"> Firstname Name<input type="text" name="firstname"> Last Name<input type="text" name="lastname"><br><br>

                                      Mobile &nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="mobile" >Relationship &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="relationship" placeholder="Father">
                                      

                            </td></tr>
                             <tr><td>
                                                                
                               <input type="submit" name="register" value="Save Record" onClick=" window.setTimeout('this.disabled=true',0);">
...
<?php
   ...
   mysql_query("INSERT INTO parents(student_id, sirname, firstname, lastname, mobile, relationship) VALUES ('$student_id','$sirname','$firstname','$lastname','$mobile','$relationship')") or die(mysql_error());
...
?>
                ...
                <script>
                alert('Parent details Succsessfully Save');
                window.location = "parents.php?id=<?php echo $id;?>";
                </script>
<?php
}?>
