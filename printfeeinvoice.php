...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li ><a href="feestructure.php">Print Fee Structure<img src="assets/img/print.png"> </a></li>                        
                     ...
                     <div class="col-sm-6" >
                        ...
                        <form method="get" action="pdf.php">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">                                      
                                        <tr>
                                            <td>
                                                <label>Enter admission to generate invoice</label>
                                        ...
                                        <td>Additional charges to be refrected in the invoice (optional)
                                        <input type="text" name="add" class="form-control" placeholder="10000 for attachment included"></td>
                                        <td>
                                        Opening date (optional)
                                        <input type="date" name="od" class="form-control"></td></tr>
