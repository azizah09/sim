       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <form action="update.php" method="POST" enctype="multipart/form-data">                         
                        ...
                        <label>Adm NO:</label>
                        <input type="text" name="student_id"  readonly value="<?php echo $id?>" class="form-control"> 
                        ...
                        <select id="intake_id" name="intake_id" value="<?php echo $intake_id?>" class="form-control">  
                                            <option></option>
                                                <?php 
                                                    $query=mysql_query("select * from intake");
                                                    while($row=mysql_fetch_array($query))
                                                     { 
                                                        if($result['intake_id'] == $row['intake_id']){
                                                            $sel = "selected";
                                                        }else{
                                                            $sel = "";
                                                        }
                                                            ?>
                                                        <option value="<?php echo $row['intake_id'];?>" <?=$sel?> > <?php echo $row['intakename'];?> </option>
                                                        <?php 
                                                    } ?>
                                                    </select>
