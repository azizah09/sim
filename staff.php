...
<!--**************************************************************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="#">New Staff Member <img src="assets/img/new.png"> </a></li>
                                  ...
                                  <li><a href="importstudentslist.php">Import Data <img src="assets/img/import.png"></a></li>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                       ...
                       <form action="staff.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="date" name="doa" required class="form-control" >
