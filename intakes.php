...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="#">New Intake<img src="assets/img/new.png"> </a></li>
  ...
  <!--*************************************************************************************************************************-->
                ...
                <div class="col-sm-6" >
                        <form action="intakes.php" method="POST" enctype="multipart/form-data">
                            <h4>Intakes</h4>
                            <label>Intake Name</label>
                            <input type="text" name="intake" class="form-control"> <br>
                                                                     
                              <input type="submit" name="register" value="Add Intake" class="btn btn-success" >
...
<?php
    ...
    if (isset($_POST['register'])){
     ...
     mysql_query("INSERT INTO intake(intakename) VALUES ('$intake')") or die(mysql_error());
...
?>
                        ...
                        window.location = "intakes.php?id=<?php echo $id;?>";
                        </script>
<?php
...
<!--**************************************************************************************DISPLAY THE INTAKES-->
                    ...
                    <tr>
                                                <th></th>
                                                <th><center>Intake ID</center></th>
                                                <th><center>Intake Name</center></th>
                    ...
                    ?>              
                                    ...
                                    <td><center><?php echo $row['intake_id']; ?></center></td>
                                    <td><center><?php echo $row['intakename']; ?></center></td>
                                    <td><center><input type="submit" name="delete" <?php echo '?id='.$id; ?>"  class="btn btn-default" data-dismiss="modal"></input>    </center></td>
                                    <td>             
                                    </tr>
                                    <?php } ?>
                                    </tbody>
