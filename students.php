                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                       ...
                       <form action="students.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" name="sirname" placeholder="Manual assingning of admission number to be activated on request" id="ssname" class="form-control" readonly="">              
...
<?php
    ...
    $xx=$_POST['intake_id'];
        $sql="SELECT * FROM intake WHERE intakename='$xx'";
        $user_query=mysqli_query($db,$sql) or die("error getting data");
        while($row = mysqli_fetch_array($user_query, MYSQL_ASSOC)){
    ...
    //<!--**************************************************************>
     ...
     mysql_query("INSERT INTO studentstable(sirname, firstname, lastname, idno, dateofbirth, gender, country_id, county_id, constituency_id, mobile, email, address, zipcode, course_id, intake_id,reg_date, feepayable) VALUES ('$sirname','$firstname','$lastname','$idno','$dateofbirth','$gender','$country_id','$county_id','$constituency_id','$mobile','$email','$address','$zipcode','$course_id','$intake_id','$reg_date','$feepayable')") or die(mysql_error());
     mysql_query("INSERT INTO parents(psirname, pfirstname, plastname, pmobile, prelationship) VALUES ('$psirname','$pfirstname','$plastname','$pmobile','$prelationship')") or die(mysql_error());
